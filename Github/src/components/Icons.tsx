...
export const FilterIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M3 4h18M6 12h12m-7 8h2" />
  </svg>
);
...
export const PipIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M15 19l-7-7 7-7" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M21 13.4V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2h7.4M15 14h6v6h-6v-6z" />
    </svg>
);
...
export const FullscreenExitIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M8 4H4v4m12 0V4h4M8 20H4v-4m12 0v4h4" />
    </svg>
);
...
export const VolumeDownIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="currentColor" viewBox="0 0 24 24">
...
export const RewindIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
        ...
        <text x="7" y="16.5" fill="currentColor" fontSize="6" fontWeight="bold" stroke="none" fontFamily="sans-serif">10</text>
    </svg>
);
...
export const ForwardIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
        ...
        <text x="17" y="16.5" fill="currentColor" fontSize="6" fontWeight="bold" stroke="none" fontFamily="sans-serif">10</text>
    </svg>
);

export const RefreshIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M16.023 9.348A8.25 8.25 0 0 1 20.25 12c0 4.556-3.694 8.25-8.25 8.25S3.75 16.556 3.75 12a8.25 8.25 0 0 1 4.227-7.22M16.023 9.348l4.227-4.227" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 2.25v4.5h-4.5" />
    </svg>
);
...
export const AspectRatioIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
        <path strokeLinecap="round" strokeLinejoin="round" d="M16 9l4-4m0 0h-4m4 0v4M8 9l-4-4m0 0h4m-4 0v4M16 15l4 4m0 0h-4m4 0v-4M8 15l-4 4m0 0h4m-4 0v-4" />
    </svg>
);
...
export const WifiOffIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
        ...
        <path d="M3.515 9.515a12 12 0 0 1 3.54 -2.22m5.138 -1.295a12.001 12.001 0 0 1 7.807 3.515"></path>
