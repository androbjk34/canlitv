...
export const RewindIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
        ...
        <text x="7" y="16.5" fill="currentColor" fontSize="6" fontWeight="bold" stroke="none" fontFamily="sans-serif">15</text>
    </svg>
);
...
export const ForwardIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
        ...
        <text x="17" y="16.5" fill="currentColor" fontSize="6" fontWeight="bold" stroke="none" fontFamily="sans-serif">15</text>
    </svg>
);
